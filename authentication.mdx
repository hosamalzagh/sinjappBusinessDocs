---
title: "Tenant API Key Authentication"
description: "Authenticate Sinjapp Business Tenant API requests using your tenant domain and X-Api-Key header, and keep API keys secure on your server."
---

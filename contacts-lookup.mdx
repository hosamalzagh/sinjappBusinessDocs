---
title: "Contacts Lookup by Phone Number"
description: "Use the Sinjapp Business contacts lookup endpoint to check whether a phone number can receive messages before sending from a tenant sender."
---

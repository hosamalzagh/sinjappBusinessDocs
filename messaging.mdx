---
title: "Send Messages and Read Tenant Logs"
description: "Send text and media messages and read tenant message logs through the Sinjapp Business Tenant API using the messages.send and messages.read scopes."
---

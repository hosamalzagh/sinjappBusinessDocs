---
title: "Sinjapp Tenant API Postman Collection"
description: "Download and configure the official Sinjapp Business Tenant API Postman collection to test sender numbers, messaging, and usage endpoints."
---

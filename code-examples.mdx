---
title: "Tenant API Code Examples in cURL, JS, PHP, Python"
description: "Copy-ready Sinjapp Tenant API examples for sending messages, listing logs, and reading usage in cURL, JavaScript, PHP, and Python."
---

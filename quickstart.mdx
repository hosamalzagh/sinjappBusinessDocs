---
title: "Quickstart: Send Your First Sinjapp Message"
description: "Open a tenant workspace, create a Sinjapp API key, add and verify a sender number, then send your first text message in seven steps."
---
